...
export default function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-600 font-dm-sans pt-[10rem]">
      <div className="bg-gray-700 rounded-lg shadow-lg p-12 w-full max-w-lg translate-y-[-8rem]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <button
            type="submit"
            className="rounded-full text-white py-2 px-4 bg-blue-500 max-w-[14rem] translate-x-[6rem] mb-4"
          >
            Login
          </button>
        </form>
