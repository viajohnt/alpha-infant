...
function Leaderboard() {
  ...
  const podiumClasses = [
    ...
    'w-60 min-h-[200px] bg-blue-500 text-white flex flex-col justify-end items-center p-4',
    'w-60 min-h-[100px] bg-green-500 text-white flex flex-col justify-end items-center p-4',
  ];
